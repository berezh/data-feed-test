...
import { FilterDataFeed, FilterSelectField, FilterBoolField, FeedFilterValues } from 'data-feed';
import { FilterTextField } from 'data-feed';
    ...
    return (
        <MasterPage>
            ...
            >
                ...
                />
                <FilterTextField name="capital" label="Capital" placeholder="Enter Capital" />
            </FilterDataFeed>
        </MasterPage>
    );
};
