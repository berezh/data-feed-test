...
import { FilterBoolField, FilterSelectField, FilterSearchField, FilterDataFeed } from 'data-feed';
...
export const NoInitialLoadPage: React.FC = () => {
    ...
    const handleChange = useCallback(
        (options: any) => {
            const { skip } = options;
            const { items: dataItems, all: allItems } = DataGenerator.loadEuState(10, options);
